...
You are provided with a title or a theme for a hypothetical story. Your task for now is to generate the story highlights from start to end in N parts. Use hypothetical character names, place, time etc. Those parts will be used further to complete the story. Keep the language simple.
